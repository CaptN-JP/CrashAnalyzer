...
# Implement GNN model to generate clusters based on Latitude and Longitude.

def gnn(data, n_clusters):
    '''
...
new_df = gnn(df[['Longitude', 'Latitude']], 7)
...
spatial_viz(
    ...
    title = "Clusters of Crashes in Montgomery County, MD [GNN]"
    )